    ...
    >
        ...
        >
            <main class="flex w-full max-w-[335px] flex-col-reverse lg:max-w-4xl lg:flex-row">
                ...
                >
                    <h1 class="mb-1 font-medium">Fila Starter Kit</h1>
                    <p class="mb-2 text-[#706f6c] dark:text-[#A1A09A]">
                        A Starter Kit For Filament with most
                        <br />
                        necessities pre-configured based on
                        <br />
                        personal preferences/requirements.
                    </p>
                    ...
                    <ul class="flex gap-3 text-sm leading-normal">
                        <li>
                            <a
                                href="https://filamentphp.com/plugins/raugadh-fila-starter"
                                target="_blank"
