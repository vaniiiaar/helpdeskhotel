...
@php
    $classes =
        $active ?? false
            ? 'inline-flex items-center border-b-2 border-indigo-400 px-1 pt-1 text-sm leading-5 font-medium text-gray-900 transition duration-150 ease-in-out focus:border-indigo-700 focus:outline-none dark:border-indigo-600 dark:text-gray-100'
